...
async function assertsOwnConversation(conversationId: string, userId: string) {
...
export async function listMessages(
    ...
    await assertsOwnConversation(conversationId, user.id);
...
export async function createMessage(conversationId: string, content: string) {
    const user = await requireUser();
    const conversation = await assertsOwnConversation(conversationId, user.id);
