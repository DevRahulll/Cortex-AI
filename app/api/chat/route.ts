...
export async function POST(req: Request) {
    ...
    const previousMessages = await await loadChatMessages(id);
    ...
    const result = streamText({
        ...
        system:
            ...
            "You are CortexAI, a helpful assistant. You give response in short and simple terms and to the point.",
